...
import aluminum.mod.blocks.BlockCrusher;
import aluminum.mod.common.AluminumMod;
import aluminum.mod.extra.CrusherRecipes;
...
public class TileEntityCrusher extends TileEntity implements IInventory
{
	...
	public void updateEntity()
	{
		...
		if(!worldObj.isRemote)
		{
			...
			{
				flag1 = true;
				BlockCrusher.updateCrusherBlockState(crusherBurnTime > 0, worldObj, xCoord, yCoord, zCoord);
			}
		}
		if(flag1)
		{
	...
	private boolean canSmelt()
	{
		...
		ItemStack itemstack = CrusherRecipes.smelting().getSmeltingResult(crusherItemStacks[0].getItem().shiftedIndex);
	...
	public void smeltItem()
	{
		...
		} else if(crusherItemStacks[2].itemID == itemstack.itemID)
		{
	...
	private int getItemBurnTime(ItemStack itemstack)
	{
		...
		if(i == AluminumMod.battery1.shiftedIndex)
		{
			return 6400;
		}
		if(i == AluminumMod.battery2.shiftedIndex)
		{
			return 12800;
		}
		if(i == AluminumMod.battery3.shiftedIndex)
		{
			return 25600;
		} else
		{
