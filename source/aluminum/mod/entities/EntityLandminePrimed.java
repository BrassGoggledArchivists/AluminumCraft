...
public class EntityLandminePrimed extends Entity
{
	public int fuse;

	public EntityLandminePrimed(World world)
	{
		super(world);
		fuse = 0;
	...
	public EntityLandminePrimed(World world, double d, double d1, double d2)
	{
		this(world);
		setPosition(d, d1, d2);
