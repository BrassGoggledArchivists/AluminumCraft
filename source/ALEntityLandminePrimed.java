...
public class ALEntityLandminePrimed extends Entity
{

    public ALEntityLandminePrimed(World world)
    {
        super(world);
        fuse = 0;
    ...
    public ALEntityLandminePrimed(World world, double d, double d1, double d2)
    {
        this(world);
        setPosition(d, d1, d2);
